...
/*
2021_SUJITHTS@ltsp1217:~/Desktop/ networking_lab/exp5/selective_repeat$ gcc server.c
2021_SUJITHTS@ltsp1217:~/Desktop/ networking_lab/exp5/selective_repeat$ ./a.out
        Server Up
 Selective repeat scheme
...
Message from Client: negative akwn-7
 corrupt message awk (msg 7) 
Resending Message to client :reserver message :7 
Message from Client: negative akwn-8
 corrupt message awk (msg 8) 
