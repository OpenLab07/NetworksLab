...
/*
2021_SUJITHTS@ltsp1217:~/Desktop/ networking_lab/exp5/go_back_N$ gcc server.c -o server
2021_SUJITHTS@ltsp1217:~/Desktop/ networking_lab/exp5/go_back_N$ ./server
        Server Up
 Go back n (n=3) used to send 10 messages 
...
Message from Client: akwnowledgementof-9
*/